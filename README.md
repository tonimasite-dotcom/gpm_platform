...
>
> Текущий production на 08.09.2026: backend и frontend `3b42d2c`.
> Переработанный мессенджер (`776d8d0`, run #14) и семь точечных правок —
> адрес/метро у исполнителя, защита опубликованных полей от повторного
> CRM-импорта, запрет логисту редактировать цены, ярлык «Любое» вместо
> «Необязательно», удаление задвоенного поля «Часы», автоподстановка дат/
> времени (`3b42d2c`, run #15) — выпущены и подтверждены success. `gh` CLI
> установлен и авторизован на этой машине для самостоятельного запуска
> деплоя. Главный актуальный источник истины:
