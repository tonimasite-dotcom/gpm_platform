...
>
> Текущий production на 09.09.2026: backend и frontend `a4a3dd6`.
> Поверх релизов 08.09 выпущены три батча правок по кабинетам (аудит
> клиента/логиста/исполнителя): общий модуль статусов/дат
> (`lib/utils/order_display.dart`), фиксы в списках и деталях заказов,
> дата заказа у клиента, форма создания (гражданство «Только РФ / Любое»,
> обязательное «Описание работ», два поля веса), разбивка сумм в финансах
> исполнителя, причёсанная «Главная» исполнителя, начисление от ставки
> исполнителя, удалена плашка в чатах (`10be0c4`, `d4c253b`, `3dfb53b`,
> `a4a3dd6`; runs 34345268272 / 34349468299 / 34355617294, все success).
> `gh` CLI установлен и авторизован на этой машине для самостоятельного
> запуска деплоя. Главный актуальный источник истины:
> `PROJECT_HANDOFF_2026-09-09_CABINET_FIXES.md`.
